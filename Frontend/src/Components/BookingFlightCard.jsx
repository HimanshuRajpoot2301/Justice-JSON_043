  ...
  return (
    <div className="bookedFlightCard">
      <div className="bookedImageSection">
        <img
          src="https://promos.makemytrip.com/notification/xhdpi/df-116x116-09092021.jpg"
          alt=""
        />
      </div>
      <div className="bookedContentSection">
        <div>
          ...
          <p className="bookedHotelSubTitle">
          ...
          <i class="uil uil-rupee-sign bookedHotelOffers">{item.fare}</i>
          <p className="bookedDate">
            Booked At:
            <span className="bookedDateSpan">
