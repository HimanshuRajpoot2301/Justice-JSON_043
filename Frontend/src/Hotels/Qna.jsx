        ...
        <div className={style_qna.botom}>
          <div className={style_qna.left}>
            ...
            <p>
              ...
              looking for hotels in the best areas, it is easy <br /> to find
              them on our website and our app. Let’s say, you are going to Goa
              and planning to book one near <br /> the most happening beaches.
              Once you have hit the Search option, you will find a list of all
              the hotels <br /> in North Goa near the famed beach areas
              including Baga and Calangute. You can even find out which <br />{' '}
              of the areas are ideal for couples and families. Similarly, if you
              are looking for booking hotels in <br /> Mumbai, you can either
              book ones that are near the city’s major business districts,
              tourist areas and <br /> transportation hubs.
            </p>
          </div>
          <div className={style_qna.left}>
